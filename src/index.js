...
ValineFactory.prototype.bind = function (option) {
    ...
    let insertDom = (rt, node, mt) => {
        ...
        _nick = _t ? `<a class="vnick" rel="nofollow" href="${_t}" target="_blank" >${rt.get("nick")}</a><span class="vtag vmaster">博主</span>` : `<span class="vnick">${rt.get('nick')}</span><span class="vtag vmaster">博主</span>`;
        _vcard.innerHTML = `${_img}
            <div class="vh" rootid=${rt.get('rid') || rt.id}>
                ...
                <div class="vmeta">
                    ...
                    <span class="vat" style="display:none;">${root.locale['ctrl']['reply']}</span>
                </div>
                <div class="vcontent">
